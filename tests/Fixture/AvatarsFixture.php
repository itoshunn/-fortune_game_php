...
class AvatarsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'img_file' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-12-28 05:28:17',
            'modified' => '2016-12-28 05:28:17'
        ],
    ];
}
